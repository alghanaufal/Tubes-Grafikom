	...
	if (lvl == 0)
	{
		...
		for (int i = 0; i < 21; i++)
			for (int j = 0; j < 21; j++)
				...
				// Coin
				case '*':
					monster.push_back(glm::vec3(wallSize * 2.0f * i - 21.0f * wallSize, 2.0f, wallSize * 2.0f * j - 21.0f * wallSize));
					break;
				// Exit
				case 'E':
	...
	else
	{
		...
		for (int i = 0; i < 31; i++)
			for (int j = 0; j < 31; j++)
				...
				// Coin
				case '*':
					monster.push_back(glm::vec3(wallSize * 2.0f * i - 31.0f * wallSize, 2.0f, wallSize * 2.0f * j - 31.0f * wallSize));
					break;
				// Exit
				case 'E':
